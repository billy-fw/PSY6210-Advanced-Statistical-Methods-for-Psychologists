...
### Practice 1- using logged outcome and centred predictor

### Practice 2- Adding an interaction term

e.g. Does inequality predict hate crime more strongly in politically conservative states?
...
lm3 <- lm(
  hate_crimes_per_100k_splc ~ 
    gini_index *share_voters_voted_trump +
